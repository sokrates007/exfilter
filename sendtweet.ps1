...
$Pinfo="Comp name eq " +  $Euname + "User name eq " + $EHname

$OAuth = @{'ApiKey' = '1'; 'ApiSecret' = '1';'AccessToken' = '1';'AccessTokenSecret' = '1'}
#Invoke-TwitterRestMethod -ResourceURL 'https://api.twitter.com/1.1/statuses/update.json' -RestVerb 'POST' -Parameters @{'status'='here we go'} -OAuthSettings $OAuth 
Invoke-TwitterRestMethod -ResourceURL 'https://api.twitter.com/1.1/statuses/update.json' -RestVerb 'POST' -Parameters @{'status'=$Pinfo} -OAuthSettings $OAuth 